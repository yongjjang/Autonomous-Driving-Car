...
class image_converter:
    def __init__(self):
        ...
        self.blocking_img = cv2.imread('blocking.png', cv2.IMREAD_COLOR)
        
        self.match_pub = rospy.Publisher("/match/is_blocking", Bool)
    ...
    def callback(self, msg):
        ...
        if len(good) > MIN_MATCH_COUNT:                         
            ...
            rospy.logdebug('Blocking Bar detected : %s' % self.match)
